...
---
name: api-designer
description: Use when designing REST APIs, reviewing endpoint structure, creating new routes, evaluating URL patterns, or improving API consistency. Triggers on tasks involving HTTP endpoints, REST resources, API responses, or route definitions.
allowed-tools: Read, Grep, Glob
---
...
---
name: code-reviewer
description: Use when reviewing code for security vulnerabilities, code quality issues, PR reviews, or auditing existing implementations. Triggers on tasks involving code review, security audit, finding bugs, or checking code quality.
allowed-tools: Read, Grep, Glob
---
...
```
What's the best URL structure for a shopping cart API?
```
