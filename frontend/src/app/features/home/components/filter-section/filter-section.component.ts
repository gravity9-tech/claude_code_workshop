    ...
    <section class="mb-8">
      <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
          <div class="flex flex-col md:flex-row gap-4 flex-1 w-full md:w-auto">
            ...
            <div class="flex-1 min-w-[200px]">
              <label for="categoryFilter" class="block text-sm font-semibold text-gray-700 mb-2">Tea Type</label>
              <select
                id="categoryFilter"
            ...
            <!-- Price Filter -->
            <div class="flex-1 min-w-[200px]">
              <label for="priceFilter" class="block text-sm font-semibold text-gray-700 mb-2">Price Range</label>
              <select
                id="priceFilter"
            ...
            <!-- Origin Filter -->
            <div class="flex-1 min-w-[200px]">
              <label for="materialFilter" class="block text-sm font-semibold text-gray-700 mb-2">Origin</label>
              <select
                id="materialFilter"
          ...
          <div class="flex flex-col justify-end w-full md:w-auto mt-2 md:mt-0">
            <label class="block text-sm font-semibold text-gray-700 mb-2 invisible hidden md:block">Actions</label>
            <button
        ...
        <div class="mt-4 text-sm text-gray-600 font-medium">
          Showing <span class="font-bold">{{ resultCount }}</span> of <span class="font-bold">{{ totalCount }}</span> products
        </div>
      </div>
    </section>
  `
