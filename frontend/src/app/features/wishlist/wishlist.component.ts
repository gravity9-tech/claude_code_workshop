    ...
    <main class="container mx-auto px-4 py-8">
      ...
      @if ((wishlistService.items$ | async)?.length === 0) {
        ...
        <div class="text-center py-16">
          ...
          <a
            routerLink="/"
            class="inline-block bg-gold hover:bg-dark-gold text-white font-semibold px-8 py-3 rounded-lg transition-colors"
          >
            Browse Teas
          </a>
        </div>
          ...
          @for (product of wishlistService.items$ | async; track product.id) {
            ...
            >
              <div class="relative overflow-hidden group">
                ...
                />
                <div
                  class="absolute top-2 right-2 bg-black/70 text-white text-xs font-bold px-2 py-1 rounded uppercase"
                >
              ...
              <div class="p-5">
                <div class="mb-3">
                  <h3 class="font-bold text-lg text-luxury mb-1 line-clamp-2">
                    {{ product.name }}
                  </h3>
