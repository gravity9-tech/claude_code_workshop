        ...
        <div class="flex justify-between items-center">
          ...
          <div class="flex items-center gap-4">
            ...
            <nav class="hidden md:flex gap-6 mr-4">
              <button
                (click)="filterCategory.emit('all')"
                class="text-white hover:text-gold transition-colors"
              >
                All
              </button>
              <button
                (click)="filterCategory.emit('black')"
                class="text-white hover:text-gold transition-colors"
              >
                Black
              </button>
              <button
                (click)="filterCategory.emit('green')"
                class="text-white hover:text-gold transition-colors"
              >
                Green
              </button>
              <button
                (click)="filterCategory.emit('oolong')"
                class="text-white hover:text-gold transition-colors"
              >
                Oolong
              </button>
              <button
                (click)="filterCategory.emit('herbal')"
                class="text-white hover:text-gold transition-colors"
              >
                Herbal
              </button>
            ...
            <a
              routerLink="/wishlist"
              class="relative text-white hover:text-gold transition-colors"
            >
              <svg
                class="w-6 h-6"
                fill="none"
              ...
              <span
                class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full px-1.5 py-0.5 text-xs font-semibold min-w-[20px] text-center"
              >
    ...
    @if (mobileMenuOpen) {
      <div class="md:hidden bg-luxury text-white">
        <nav class="container mx-auto px-4 py-4 flex flex-col gap-3">
          <button
            (click)="onMobileFilter('all')"
            class="text-left hover:text-gold transition-colors py-2"
          >
            All Teas
          </button>
          <button
            (click)="onMobileFilter('black')"
            class="text-left hover:text-gold transition-colors py-2"
          >
            Black Tea
          </button>
          <button
            (click)="onMobileFilter('green')"
            class="text-left hover:text-gold transition-colors py-2"
          >
            Green Tea
          </button>
          <button
            (click)="onMobileFilter('oolong')"
            class="text-left hover:text-gold transition-colors py-2"
          >
            Oolong Tea
          </button>
          <button
            (click)="onMobileFilter('herbal')"
            class="text-left hover:text-gold transition-colors py-2"
          >
            Herbal Tea
          </button>
